...
var TableRow = React.memo(function (_ref) {
  ...
  var onDragStartEvt = React.useCallback(function (e) {
    onDragStart(row, e);
  }, [draggable, row]);
  var onDragOverEvt = React.useCallback(function (e) {
    onDragOver(row, e);
  }, [draggable]);
  var onDropEvt = React.useCallback(function (e) {
    onDrop(row, e);
  }, [draggable, row]);
...
var DataTable = React.memo(function (_ref) {
  ...
  var onDragStartEvt = React.useCallback(function (row, e) {
    return onDragStart(row, e);
  }, [onDragStart]);
  var onDropEvt = React.useCallback(function (row, e) {
    return onDrop(row, e);
  }, [onDrop]);
  var onDragOverEvt = React.useCallback(function (row, e) {
    return onDragOver(row, e);
  }, [onDragOver]);
  ...
  }, subHeaderComponent), !progressPending && data.length > 0 && /*#__PURE__*/React__default.createElement(TableBody, {
